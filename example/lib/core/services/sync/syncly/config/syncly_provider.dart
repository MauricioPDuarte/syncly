...
import 'package:syncly_example/core/services/sync/syncly/strategies/todo_download_strategy.dart';
...
class SynclyProvider extends SyncProvider {
  ...
  void _initializeProviders() {
    ...
    _downloadStrategies = [TodoDownloadStrategy()];
  }

  /// Método simplificado para inicializar o sistema de sincronização
  /// Usa o novo SyncProvider centralizado
  static Future<void> initializeSync() async {
    final provider = Modular.get<SynclyProvider>();
  ...
  Future<SyncHttpResponse<T>> httpGet<T>(
    ...
    throw UnimplementedError('HTTP operations not implemented in example');
  }
